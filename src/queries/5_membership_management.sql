...
SELECT ms.type AS membership_type, 
    AVG((JULIANDAY(a.check_out_time) - JULIANDAY(a.check_in_time)) * 24 * 60) AS avg_visit_duration_minutes --uses julian day and * by 24 and 60 to get the average minutes from a date
